          ...
          <div>
           ...
           <div className='flex flex-col gap-5'>
            ...
            <div className='text-slate-600'>
              <p>
                    {product?.description?.substring(0, 230) || 'Loading description...'}...
                  </p>
            ...
            <div onClick={inc} className='px-6 cursor-pointer'>+</div>
                ...
                <div>
                        <button onClick={add_cart}  className='px-8 py-3 h-[50px] cursor-pointer hover:shadow-lg hover:shadow-green-500/40 bg-[#059473] text-white'>Add To Card</button>
                </div>
