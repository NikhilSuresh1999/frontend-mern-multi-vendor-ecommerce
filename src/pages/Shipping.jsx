                      ...
                      
                    {
...

                     {
                      res &&  <div className='flex flex-col gap-1'>
                        ...
                        <p className='text-slate-600 text-sm' >Email To nikhil@gmail.com</p>
                      ...
                      <div key={i} className="flex bg-white p-4 flex-col gap-2">
                        ...
                        {p.products.map((pt, i) => (
                          <div className="w-full flex flex-wrap">
                            ...
                            <div className="flex gap-6 w-5/12 sm:w-full sm:mt-3">
                              <div className="pl-4 sm:pl-0">
                                ...
                                <div className="flex bg-slate-200 rounded-md h-[30px] justify-center items-center text-xl">
                                  
                                  <div className="px-3">({pt.quantity}) items</div>
                              </div>
                            </div>
                          </div>
                        ))}
